...
public class Env {
	...
	// UpperNameComparator comes from openjdk's ProcessEnvironment.java
	private static final class UpperNameComparator implements Comparator<String>, Serializable {
		private static final long serialVersionUID = 1457973420L;
	...
	private static final UpperNameComparator upperNameComparator = new UpperNameComparator();

	private static Map<String, String> makeContext() {
		if (getOS().equals(OS.WINDOWS)) {
			return new TreeMap<>(upperNameComparator);
		} else {
