...
with open(makefile, "w") as f:
  ...
  f.write("nexus-maven-repository-index.gz:\n\tcurl -L -O https://repo1.maven.org/maven2/.index/nexus-maven-repository-index.gz\n\n")
...
with open(makefile, "w") as f:
  ...
  f.write("%s: %s\n\tpython %s %s %s %s\n\n" % (package_index_file, inverted_index_file, pick_jars_script, jar_indices_dir, inverted_index_file, package_index_file))
